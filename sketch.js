let perguntas = [
  {
    pergunta: "Que produtos são cultivados?",
    opcoes: [
      "Areia",
      "Industrializados",
      "Soja, trigo, milho",
  ...
  {
    pergunta: "Qual é o maior desafio na agricultura?",
    opcoes: [
  ...
  },
  {
    ...
    opcoes: [
      ...
      "Industrializado",
      "Cultivado em florestas"
    ],
    correta: 1
  },
  {
    pergunta: "Quais são os 4 tipos de agricultura?",
    opcoes: [
      "líquido, gassoso, sólido, plasma",
      " extensiva, intensiva, familiar e orgânica",
      " evaporação, ebulição e calefação",
      "água, chocolate, leite"
    ],
    correta: 1
  },
  {
